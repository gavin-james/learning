...
public class EncryptUtils {
    ...
    public static String encodeMD5String(String str) {
        return EncryptUtils.encode(str, "MD5");
    }
    ...
    public static String encodeSHAString(String str) {
        return EncryptUtils.encode(str, "SHA");
    }
    ...
    private static String encode(String str, String method) {
        ...
        try {
            ...
            dstr = EncryptUtils.byte2hex(md.digest());
    ...
    public static byte[] encrypt(byte[] src, byte[] key) throws Exception {
        ...
        // 一个SecretKey对象
        SecretKeyFactory keyFactory = SecretKeyFactory.getInstance(EncryptUtils.DES);
    ...
    public static String decrypt(String data) {
        try {
            return new String(EncryptUtils.decrypt(EncryptUtils.hex2byte(data.getBytes()), EncryptUtils.HTJS_CRYPT_KEY.getBytes()));
        } catch (Exception e) {
            //Log.error(EncryptUtils.class,e.getMessage());
        }
        return null;
    ...
    public static String encrypt(String str) {
        try {
            return EncryptUtils.byte2hex(EncryptUtils.encrypt(str.getBytes(), EncryptUtils.HTJS_CRYPT_KEY.getBytes()));
        } catch (Exception e) {
            //Log.error(EncryptUtils.class,e.getMessage());
        }
        return null;
